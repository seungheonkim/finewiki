						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">글제목 : ${stock.title}</h3>
								</div>
								...
								<div class="card-footer">
									<div class="user-block">
										...
										<span class="username"> <a href="#">${stock.mem_nick}</a>
										</span> <span class="description"><fmt:formatDate
												pattern="yyyy-MM-dd" value="${stock.regdate}" /></span>
									</div>
								</div>
								<div class="card-footer">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$(".modBtn").on("click", function() {
				formObj.attr("action", "${path}/board/stock/modify");
				formObj.attr("method", "get");
				formObj.submit();
			});
			$(".delBtn").on("click", function() {
				formObj.attr("action", "${path}/board/stock/remove");
				formObj.submit();
			});
			$(".listBtn").on("click", function() {
				formObj.attr("action", "${path}/board/stock/list");
				formObj.attr("method", "get");
				formObj.submit();
			});
		});
