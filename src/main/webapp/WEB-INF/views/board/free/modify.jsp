									...
									<div class="card-body">
										...
										<div class="form-group">
											...
											<textarea class="form-control" id="content" name="content"
												rows="30" placeholder="내용을 입력해주세요" style="resize: none;">${free.content}</textarea>
										</div>
										<div class="form-group">
											<label for="mem_nick">작성자</label> <input class="form-control"
												id="mem_nick" name="mem_nick" value="${free.mem_nick}"
												readonly>
										</div>
									</div>
						...
						function() {
							...
							$(".listBtn")
									.on(
											"click",
											function() {
												self.location = "${path}/board/free/list?page=${searchCriteria.page}"
